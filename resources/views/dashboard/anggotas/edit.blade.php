...
<div class="col-lg-8">
  ...
  <form method="post" action="/dashboard/anggotas/{{ $anggota->slug }}" class="mb-5">
    @method('put')
    ...
    <div class="mb-3">
      ...
      <input type="text" class="form-control @error('name') is-invalid @enderror" id="name" name="name" required
        autofocus value="{{ old('name',$anggota->name) }}">
      @error('name')
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control @error('height') is-invalid @enderror" id="height" name="height" required
        value="{{ old('height',$anggota->height) }}"><small class="text-muted">cm</small>
      @error('height')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control @error('weight') is-invalid @enderror" id="weight" name="weight" required
        value="{{ old('weight',$anggota->weight) }}"><small class="text-muted">kg</small>
      @error('weight')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
    ...
    <div class="mb-3">
      ...
      <input type="number" class="form-control @error('number') is-invalid @enderror" id="number" name="number" required
        value="{{ old('number',$anggota->number) }}">
      @error('number')
      <div class="invalid-feedback">
        {{ $message }}
      </div>
